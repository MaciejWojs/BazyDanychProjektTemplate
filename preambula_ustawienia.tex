...
% Parametr #1 (opcjonalny): Szerokość zdjęcia (domyślnie \textwidth)
% Parametr #2: Nazwa pliku z rozszerzeniem (np. rys/nazwa-rysunku.png)
% Parametr #3: Opis rysunku wyświetlany pod rysunkiem
